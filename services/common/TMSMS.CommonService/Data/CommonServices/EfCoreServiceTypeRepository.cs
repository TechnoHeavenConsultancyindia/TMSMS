...
{
    public abstract class EfCoreServiceTypeRepositoryBase : EfCoreRepository<CommonServiceDbContext, ServiceType, int>
    {
        public EfCoreServiceTypeRepositoryBase(IDbContextProvider<CommonServiceDbContext> dbContextProvider)
