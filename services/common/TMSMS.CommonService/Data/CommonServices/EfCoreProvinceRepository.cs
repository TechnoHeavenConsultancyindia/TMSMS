...
{
    public abstract class EfCoreProvinceRepositoryBase : EfCoreRepository<CommonServiceDbContext, Province, int>
    {
        public EfCoreProvinceRepositoryBase(IDbContextProvider<CommonServiceDbContext> dbContextProvider)
