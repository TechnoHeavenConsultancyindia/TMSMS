...
namespace TMSMS.CommonService.Tests;

/* This project has a dotnet project reference to the TMSMS.CommonService project,
 * but it does not have a module dependency to the TMSMSCommonServiceModule module class.
 * Because, TMSMSCommonServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSCommonServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSCommonServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSCommonServiceModule))]
public class CommonServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<CommonServiceDataSeeder>()
            .SeedAsync();
    }
