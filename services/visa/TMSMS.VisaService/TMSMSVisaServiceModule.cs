...
using TMSMS.VisaService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSVisaServiceContractsModule),
...
public class TMSMSVisaServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSVisaServiceModule>();
        });
    }
    ...
    private void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        if (IsSwaggerEnabled(configuration))
        {
            context.Services.AddAbpSwaggerGenWithOAuth(
                ...
                {
                    {"VisaService", "VisaService Service API"}
                },
                options =>
                {
    ...
    private void ConfigureDatabase(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpDbContext<VisaServiceDbContext>(options =>
        {
            ...
            options.AddRepository<VisaDiscountCategory, VisaServices.EfCoreVisaDiscountCategoryRepository>();
    ...
    private void ConfigureDistributedEventBus()
    {
        Configure<AbpDistributedEventBusOptions>(options =>
        {
            ...
            {
                config.UseDbContext<VisaServiceDbContext>();
            });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSVisaServiceModule).Assembly, opts =>
                {
                    opts.RemoteServiceName = VisaRemoteServiceConsts.RemoteServiceName;
                    opts.RootPath = VisaRemoteServiceConsts.ModuleName;
                });
        });
    }
