...
namespace TMSMS.VisaService.Tests;

/* This project has a dotnet project reference to the TMSMS.VisaService project,
 * but it does not have a module dependency to the TMSMSVisaServiceModule module class.
 * Because, TMSMSVisaServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSVisaServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSVisaServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSVisaServiceModule))]
public class VisaServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<VisaServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // VisaServiceDbContext ()
        new VisaServiceDbContext(
            new DbContextOptionsBuilder<VisaServiceDbContext>().UseSqlite(connection).Options
