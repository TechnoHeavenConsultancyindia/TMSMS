...
using TMSMS.ChatService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSChatServiceContractsModule),
...
public class TMSMSChatServiceModule : AbpModule
{
    ...
    {
        context.Services.AddChatServiceHealthChecks();
    }
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSChatServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSChatServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSChatServiceModule).Assembly, opts =>
                {
