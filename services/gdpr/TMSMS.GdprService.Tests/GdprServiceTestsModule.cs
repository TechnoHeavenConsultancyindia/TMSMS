...
namespace TMSMS.GdprService.Tests;

/* This project has a dotnet project reference to the TMSMS.GdprService project,
 * but it does not have a module dependency to the TMSMSGdprServiceModule module class.
 * Because, TMSMSGdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSGdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSGdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSGdprServiceModule))]
