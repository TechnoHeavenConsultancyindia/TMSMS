...
using TMSMS.GdprService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSGdprServiceContractsModule),
...
public class TMSMSGdprServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSGdprServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSGdprServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSGdprServiceModule).Assembly, opts =>
                {
