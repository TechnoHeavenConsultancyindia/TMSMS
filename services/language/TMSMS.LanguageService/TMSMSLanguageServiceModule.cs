...
using Volo.Abp.LanguageManagement.EntityFrameworkCore;
using TMSMS.LanguageService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSLanguageServiceContractsModule),
...
public class TMSMSLanguageServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<TMSMSLanguageServiceContractsModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        string.Format(
                            "..{0}TMSMS.LanguageService.Contracts",
        ...
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            options.FileSets.AddEmbedded<TMSMSLanguageServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSLanguageServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSLanguageServiceModule).Assembly, opts =>
                {
