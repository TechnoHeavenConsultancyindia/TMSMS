...
namespace TMSMS.TourService.Tests;

/* This project has a dotnet project reference to the TMSMS.TourService project,
 * but it does not have a module dependency to the TMSMSTourServiceModule module class.
 * Because, TMSMSTourServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSTourServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSTourServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSTourServiceModule))]
public class TourServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<TourServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // TourServiceDbContext ()
        new TourServiceDbContext(
            new DbContextOptionsBuilder<TourServiceDbContext>().UseSqlite(connection).Options
