...
using TMSMS.FileManagementService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSFileManagementServiceContractsModule),
...
public class TMSMSFileManagementServiceModule : AbpModule
{
    ...
    {
        context.Services.AddFileManagementServiceHealthChecks();
    }
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSFileManagementServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSFileManagementServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSFileManagementServiceModule).Assembly, opts =>
                {
