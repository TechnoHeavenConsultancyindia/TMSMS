...
namespace TMSMS.IdentityService.Tests;

/* This project has a dotnet project reference to the TMSMS.IdentityService project,
 * but it does not have a module dependency to the TMSMSIdentityServiceModule module class.
 * Because, TMSMSIdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSIdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSIdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSIdentityServiceModule))]
