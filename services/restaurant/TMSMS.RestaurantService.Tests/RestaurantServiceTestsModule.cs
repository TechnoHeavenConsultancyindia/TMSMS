...
namespace TMSMS.RestaurantService.Tests;

/* This project has a dotnet project reference to the TMSMS.RestaurantService project,
 * but it does not have a module dependency to the TMSMSRestaurantServiceModule module class.
 * Because, TMSMSRestaurantServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSRestaurantServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSRestaurantServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSRestaurantServiceModule))]
public class RestaurantServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<RestaurantServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // RestaurantServiceDbContext ()
        new RestaurantServiceDbContext(
            new DbContextOptionsBuilder<RestaurantServiceDbContext>().UseSqlite(connection).Options
