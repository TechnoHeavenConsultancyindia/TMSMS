...
using TMSMS.AuditLoggingService.Data;
using Volo.Abp;
...
namespace TMSMS.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the TMSMS.AuditLoggingService project,
 * but it does not have a module dependency to the TMSMSAuditLoggingServiceModule module class.
 * Because, TMSMSAuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSAuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSAuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSAuditLoggingServiceModule))]
