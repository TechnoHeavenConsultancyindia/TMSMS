...
using TMSMS.AuditLoggingService.HealthChecks;
using Prometheus;
...
[DependsOn(
    typeof(TMSMSAuditLoggingServiceContractsModule),
...
public class TMSMSAuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSAuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSAuditLoggingServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSAuditLoggingServiceModule).Assembly, opts =>
                {
