...
namespace TMSMS.AgentService.Tests;

/* This project has a dotnet project reference to the TMSMS.AgentService project,
 * but it does not have a module dependency to the TMSMSAgentServiceModule module class.
 * Because, TMSMSAgentServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSAgentServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSAgentServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSAgentServiceModule))]
public class AgentServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<AgentServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // AgentServiceDbContext ()
        new AgentServiceDbContext(
            new DbContextOptionsBuilder<AgentServiceDbContext>().UseSqlite(connection).Options
