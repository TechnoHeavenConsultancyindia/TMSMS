...
namespace TMSMS.SaasService.Tests;

/* This project has a dotnet project reference to the TMSMS.SaasService project,
 * but it does not have a module dependency to the TMSMSSaasServiceModule module class.
 * Because, TMSMSSaasServiceModule has configurations proper for development and production
 ...
 *
 * For example, TMSMSSaasServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change TMSMSSaasServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(TMSMSSaasServiceModule))]
