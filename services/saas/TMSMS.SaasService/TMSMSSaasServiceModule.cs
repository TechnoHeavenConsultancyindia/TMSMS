...
using TMSMS.SaasService.HealthChecks;
...
[DependsOn(
    ...
    typeof(TMSMSSaasServiceContractsModule),
...
public class TMSMSSaasServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<TMSMSSaasServiceModule>();
        });
    }
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<TMSMSSaasServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(TMSMSSaasServiceModule).Assembly, opts =>
                {
